...
echo "Based on the frequency of occurrence of the atoms ($molecule) in the DCD frames as shown above, enter the minimum frequency that should be considered for the calculation and press [ENTER]:
...
rm -rf $address/$filename/step*.pdb $address/$filename/tempPDBs $address/$filename/file*.txt
