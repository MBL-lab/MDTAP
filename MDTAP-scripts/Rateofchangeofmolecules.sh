...
(e.g the molar volume of Water = 18.07cm^3, Sodium = 23.78cm^3, and Chlorine = 22.40cm^3. Note: The user is free to enter any value specific to your molecule of interest apart from the examples given.)"
    read volume
