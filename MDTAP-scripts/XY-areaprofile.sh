...
for ((a=$z1; a>=$z2; a--)); do
{
    ...
    # Number of bins in X and Y directions (you can adjust these values)
...
for ((a=$z1; a>=$z2; a--)); do
{
    ...
    set output '$address/$filename/XY-density-Z-$a-$z2new.png'
...
wd=`pwd`
cd $address/$filename
gif_sort=($(ls -vr XY-density-Z-*.png))
