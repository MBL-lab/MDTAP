...
echo "The user can verify the PDBs generated by this module and further track the path traced by the atom numbers listed using the 'Track molecule' (APM #8)"
